...
## [ ] 2026-08-13 Chrome 登录态抓 GSC 的可复用路径（路 1 首次走通）
...
## [ ] 2026-08-13 设备沙箱里 Next.js build 挂起 —— Next 站构建必须走云端
...
## [ ] 2026-08-13 AdSense 后台与 Chrome 主登录账号不一致 —— 枚举两次即停

**实验条件**：zsn2740784715 登录态访问 adsense 报「无权访问」，选择器列出 ywx574708831 / julywxy9 / wanxy2124；
u/1、u/2 枚举均落回无权限页，切账号要重输密码（自动化不做）。站主确认所属账号为 **ywx574708831@gmail.com**。

**结论**：这种账号结构下审核状态核对是硬账号停点，直接记操作卡；档案里记下 AdSense 所属 Google 账号。

**并入**：`seo-yunying` 五·五 执行注记。

## [ ] 2026-08-13 特典物品名必须逐字来自店铺页 —— "Polaris" 是编造名，污染了六个语种
